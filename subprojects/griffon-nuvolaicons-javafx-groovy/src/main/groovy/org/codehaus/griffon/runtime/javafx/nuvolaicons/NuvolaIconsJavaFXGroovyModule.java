...
import griffon.builder.javafx.NuvolaIconsJavaFXBuilderCustomizer;
...
@Named("nuvolaicons-javafx-groovy")
@ServiceProviderFor(Module.class)
public class NuvolaIconsJavaFXGroovyModule extends AbstractModule {
    @Override
