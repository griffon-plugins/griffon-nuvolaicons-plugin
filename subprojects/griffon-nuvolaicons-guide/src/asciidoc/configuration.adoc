...
----
dependencies {
    griffon '{project-group}:griffon-nuvolaicons-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-nuvolaicons-swing:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-nuvolaicons-javafx:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-nuvolaicons-swing-groovy:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-nuvolaicons-javafx-groovy:{project-version}'
}
----
