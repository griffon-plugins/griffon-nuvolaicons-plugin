...
----
dependencies {
    griffon '{groupId}:griffon-nuvolaicons-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-nuvolaicons-swing:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-nuvolaicons-javafx:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-nuvolaicons-swing-groovy:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-nuvolaicons-javafx-groovy:{project-version}'
}
----
